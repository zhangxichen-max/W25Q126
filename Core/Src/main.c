...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
// ****************** 使能串口5中断 **********************//
	__HAL_UART_ENABLE_IT(&huart5, UART_IT_IDLE);   //使能串口5 IDLE中断
	...
	// 采用三个扇区进行读写：0~0x200:当前, 0x300~0x500:净入累计, 0x600 ~ 0x800:脏出累计
